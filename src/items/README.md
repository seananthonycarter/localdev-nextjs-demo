...
* `localdev-nextjs-demo.module.json` contains developer-owned configuration items
  which are created by the JSS Styleguide sample.
* `localdev-nextjs-demo-Content.module.json` contains content items which are
