...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.localdev_nextjs_demo.localhost/ --auth https://id.localdev_nextjs_demo.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.localdev_nextjs_demo.localhost/ --auth https://id.localdev_nextjs_demo.localhost/ --allow-write true
}
...
Start-Process https://cm.localdev_nextjs_demo.localhost/sitecore/
Start-Process https://www.localdev_nextjs_demo.localhost/
