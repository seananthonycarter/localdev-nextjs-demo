...
try {
    ...
    & $mkcert -install
    & $mkcert "*.localdev_nextjs_demo.localhost"
...
Add-HostsEntry "cm.localdev_nextjs_demo.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.localdev_nextjs_demo.localhost"
}
Add-HostsEntry "id.localdev_nextjs_demo.localhost"
Add-HostsEntry "www.localdev_nextjs_demo.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.localdev_nextjs_demo.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.localdev_nextjs_demo.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.localdev_nextjs_demo.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.localdev_nextjs_demo.localhost"
